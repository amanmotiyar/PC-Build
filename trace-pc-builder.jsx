...
import {
  Cpu, Fan, CircuitBoard, MemoryStick, HardDrive, Zap, Box, Monitor,
  Layers, Droplet, Wind, AppWindow, Share2, Save, Check, AlertTriangle,
  X, ChevronRight, ChevronDown, Copy, Sparkles, Plus, Trash2, RotateCcw,
  Search, Gauge, FolderOpen,
} from "lucide-react";

/* =========================================================================
   DATA — mock catalogue. Swap for a live pricing API later; shape stays same.
   ========================================================================= */

const DATA = {
  cpu: [
    { id: "cpu-r5-7600", brand: "AMD", name: "Ryzen 5 7600", socket: "AM5", cores: 6, threads: 12, tdp: 65, tier: "Budget", price: 16500 },
    { id: "cpu-i5-14600k", brand: "Intel", name: "Core i5-14600K", socket: "LGA1700", cores: 14, threads: 20, tdp: 125, tier: "Mainstream", price: 26000 },
    ...
    { id: "cpu-r7-9800x3d", brand: "AMD", name: "Ryzen 7 9800X3D", socket: "AM5", cores: 8, threads: 16, tdp: 120, tier: "Enthusiast", price: 48000 },
    { id: "cpu-ultra9-285k", brand: "Intel", name: "Core Ultra 9 285K", socket: "LGA1851", cores: 24, threads: 24, tdp: 125, tier: "Enthusiast", price: 52000 },
    { id: "cpu-r9-9950x3d", brand: "AMD", name: "Ryzen 9 9950X3D", socket: "AM5", cores: 16, threads: 32, tdp: 170, tier: "Enthusiast", price: 68000 },
  ],
  cooler: [
    ...
    { id: "cool-afl3-360", brand: "Arctic", name: "Liquid Freezer III Pro 360", type: "AIO", sockets: ["AM5", "AM4", "LGA1700", "LGA1851"], radiator: 360, tier: "High-End", price: 12000 },
  ...
  motherboard: [
    ...
    { id: "mb-tufb650", brand: "ASUS", name: "TUF Gaming B650-PLUS WiFi", socket: "AM5", chipset: "B650", formFactor: "ATX", ramType: "DDR5", wifi: true, tier: "Mainstream", price: 19000 },
    ...
    { id: "mb-tomahawk", brand: "MSI", name: "MAG B650 Tomahawk WiFi", socket: "AM5", chipset: "B650", formFactor: "ATX", ramType: "DDR5", wifi: true, tier: "High-End", price: 22000 },
    { id: "mb-z790p", brand: "MSI", name: "PRO Z790-P WiFi", socket: "LGA1700", chipset: "Z790", formFactor: "ATX", ramType: "DDR5", wifi: true, tier: "High-End", price: 21000 },
    { id: "mb-z890p", brand: "ASUS", name: "Prime Z890-P WiFi", socket: "LGA1851", chipset: "Z890", formFactor: "ATX", ramType: "DDR5", wifi: true, tier: "Enthusiast", price: 26000 },
  ],
  gpu: [
    { id: "gpu-4060", brand: "ASUS", name: "Dual RTX 4060 8GB", vram: 8, length: 220, tdp: 115, tier: "Budget", price: 29000 },
    { id: "gpu-5070", brand: "ASUS", name: "TUF Gaming RTX 5070 12GB", vram: 12, length: 300, tdp: 250, tier: "Mainstream", price: 62000 },
    { id: "gpu-5070ti-tuf", brand: "ASUS", name: "TUF Gaming RTX 5070 Ti 16GB", vram: 16, length: 305, tdp: 300, tier: "High-End", price: 115000 },
    { id: "gpu-5070ti-zotac", brand: "Zotac", name: "Trinity RTX 5070 Ti 16GB", vram: 16, length: 315, tdp: 300, tier: "High-End", price: 110000 },
    { id: "gpu-5070ti-msi", brand: "MSI", name: "Gaming Trio OC RTX 5070 Ti 16GB", vram: 16, length: 330, tdp: 300, tier: "High-End", price: 122000 },
    { id: "gpu-5080", brand: "Gigabyte", name: "Gaming OC RTX 5080 16GB", vram: 16, length: 340, tdp: 360, tier: "Enthusiast", price: 155000 },
  ],
  ram: [
    ...
    { id: "ram-ddr5-32-6000kf", brand: "Kingston", name: "Fury Beast 32GB (2x16) DDR5-6000 CL36", type: "DDR5", capacity: 32, speed: 6000, cl: 36, tier: "Mainstream", price: 12500 },
    { id: "ram-ddr5-32-6000gs", brand: "G.Skill", name: "Ripjaws S5 32GB (2x16) DDR5-6000 CL30", type: "DDR5", capacity: 32, speed: 6000, cl: 30, tier: "High-End", price: 14000 },
    { id: "ram-ddr5-32-6000tz", brand: "G.Skill", name: "Trident Z5 RGB 32GB (2x16) DDR5-6000 CL30", type: "DDR5", capacity: 32, speed: 6000, cl: 30, tier: "High-End", price: 16500 },
    { id: "ram-ddr5-64-6000", brand: "Corsair", name: "Vengeance 64GB (2x32) DDR5-6000 CL30", type: "DDR5", capacity: 64, speed: 6000, cl: 30, tier: "Enthusiast", price: 28000 },
  ],
  storage: [
    ...
    { id: "ssd-sn770-1tb", brand: "WD", name: "Black SN770 1TB NVMe Gen4", type: "NVMe Gen4", capacity: 1024, tier: "Mainstream", price: 7000 },
    { id: "ssd-sn850x-2tb", brand: "WD", name: "Black SN850X 2TB NVMe Gen4", type: "NVMe Gen4", capacity: 2048, tier: "High-End", price: 13500 },
    { id: "ssd-990pro-2tb", brand: "Samsung", name: "990 Pro 2TB NVMe Gen4", type: "NVMe Gen4", capacity: 2048, tier: "High-End", price: 14000 },
  ...
  psu: [
    ...
    { id: "psu-rm1000x", brand: "Corsair", name: "RM1000x 1000W", wattage: 1000, efficiency: "80+ Gold", modular: true, tier: "Enthusiast", price: 15000 },
    { id: "psu-tx1300", brand: "Seasonic", name: "Prime TX-1300 1300W", wattage: 1300, efficiency: "80+ Titanium", modular: true, tier: "Enthusiast", price: 28000 },
  ],
  cabinet: [
  ...
  monitor: [
    ...
    { id: "mon-27gp850", brand: "LG", name: "27GP850 27\u2033 165Hz QHD", size: 27, resolution: "2560x1440", refresh: 165, tier: "Mainstream", price: 26000 },
    { id: "mon-odysseyg7", brand: "Samsung", name: "Odyssey G7 32\u2033 240Hz QHD", size: 32, resolution: "2560x1440", refresh: 240, tier: "High-End", price: 42000 },
    { id: "mon-pg27aqdm", brand: "ASUS", name: "ROG Swift PG27AQDM 27\u2033 OLED 240Hz QHD", size: 27, resolution: "2560x1440", refresh: 240, tier: "Enthusiast", price: 68000 },
  ],
  os: [
...
const REQUIRED_IDS = CATEGORIES.filter((c) => c.required).map((c) => c.id);
...
function optionPreviewLevel(catId, option, sel) {
  // Quick pairwise check used on option cards, before full selection.
...
/* =========================================================================
   STORAGE HELPERS (window.storage — see persistent_storage_for_artifacts)
   ========================================================================= */
...
function TierPill({ tier, active, onClick }) {
  return (
    <button className={`pill ${active ? "pill-active" : ""}`} onClick={onClick} type="button">
      {tier}
    </button>
  );
}
...
function OptionCard({ option, category, selected, level, onSelect }) {
  const specs = useMemo(() => {
    switch (category.id) {
      ...
      case "fans":
        return [`${option.size}mm \u00d7 ${option.count}`, option.argb ? "ARGB" : "No RGB"];
      case "monitor":
  ...
  return (
    <button type="button" className={`opt-card ${selected ? "opt-card-selected" : ""}`} onClick={() => onSelect(option)}>
      <div className="opt-top">
        <span className="opt-brand">{option.brand}</span>
        <StatusDot level={selected ? "ok" : level} />
      </div>
      <div className="opt-name">{option.name}</div>
      <div className="opt-specs">
        {specs.map((s, i) => (
          <span className="spec-chip" key={i}>{s}</span>
        ))}
      </div>
      <div className="opt-bottom">
        <span className="opt-tier">{option.tier}</span>
        <span className="opt-price mono">{INR(option.price)}</span>
      </div>
      {selected && <div className="opt-selected-badge"><Check size={13} strokeWidth={3} /> Selected</div>}
    </button>
  );
}
...
function TicketRow({ cat, option, active, onClick, issueLevel }) {
  const Icon = cat.icon;
  return (
    <button type="button" className="ticket-row" onClick={onClick}>
      <span className={`ticket-node ${option ? (issueLevel === "error" ? "node-error" : "node-ok") : "node-empty"}`}>
        <Icon size={14} />
      </span>
      <span className="ticket-text">
        <span className="ticket-cat">{cat.short}{!cat.required && <em className="opt-suffix"> \u00b7 optional</em>}</span>
        <span className="ticket-name">{option ? option.name : "Not selected"}</span>
      </span>
      <span className="ticket-price mono">{option ? INR(option.price) : "\u2014"}</span>
    </button>
  );
}

/* =========================================================================
   3D BUILD STAGE — stylized live model that grows as parts are picked.
   Real product photography isn't used (licensing + reliability), so every
   part is a deliberate low-poly stand-in colored by its compatibility
   status — same status language as the rail and ticket.
   ========================================================================= */

const CATEGORY_MAP = Object.fromEntries(CATEGORIES.map((c) => [c.id, c]));

// Fractional anchor inside (or just outside) the case volume: x 0=left wall..1=right wall,
// y 0=floor..1=top, z 0=back..1=front. Values >1 / above 1 sit outside the case on purpose.
...
const STATUS_HEX = { ok: 0x4fd8c9, warn: 0xe8b339, error: 0xf2545b, empty: 0x4b5460 };
...
function buildCaseShell(dims, cabinet) {
  ...
  const tint = !cabinet ? 0x4b5460 : tier === "Budget" ? 0x6b7280 : tier === "Mainstream" ? 0x8a96a3 : tier === "High-End" ? 0x4fd8c9 : 0xc9824a;
  ...
  if (cabinet) {
    ...
    const fill = new THREE.Mesh(new THREE.BoxGeometry(w, h, d), stdMat(0x000000, { opacity: 0.12, side: THREE.BackSide }));
    fill.position.y = h / 2;
    group.add(fill);
  }
  return group;
...
function buildMotherboard(pos, mobo) {
  const group = new THREE.Group();
  const plate = new THREE.Mesh(new THREE.BoxGeometry(0.1, 4.6, 4.4), stdMat(0x1f3d2e, { roughness: 0.7, metalness: 0.1 }));
  plate.position.copy(pos);
  group.add(plate);
  const trim = new THREE.Mesh(new THREE.BoxGeometry(0.11, 0.18, 4.4), stdMat(0xc9824a, { metalness: 0.6, roughness: 0.4 }));
...
function buildCpu(pos, status) {
  const m = new THREE.Mesh(new THREE.BoxGeometry(0.18, 0.85, 0.85), stdMat(0x2a2f37, { metalness: 0.5 }));
  m.position.copy(pos);
...
function buildCooler(pos, cooler, dims, status) {
  ...
  if (cooler.type === "Air") {
    const base = new THREE.Mesh(new THREE.BoxGeometry(0.95, 0.16, 0.95), stdMat(0x30363f, { metalness: 0.6 }));
    base.position.set(pos.x - 0.1, pos.y, pos.z);
    group.add(base);
    const heightU = (cooler.height / 100) * 0.95;
    for (let i = 0; i < 6; i++) {
      const fin = new THREE.Mesh(new THREE.BoxGeometry(0.04, heightU, 0.82), stdMat(0x454c57, { metalness: 0.7, roughness: 0.3 }));
    ...
    const pump = new THREE.Mesh(new THREE.BoxGeometry(0.5, 0.22, 0.5), stdMat(0x2a2f37, { metalness: 0.6 }));
    ...
    const radiator = new THREE.Mesh(new THREE.BoxGeometry(1.3, 0.16, radLenU), stdMat(0x30363f, { metalness: 0.7 }));
    radiator.position.copy(radPos);
    group.add(radiator);
    for (let i = -1; i <= 1; i += 2) {
      const fan = new THREE.Mesh(new THREE.CylinderGeometry(0.45, 0.45, 0.06, 16), stdMat(0x3a4047, { metalness: 0.5 }));
    ...
    [0.15, -0.15].forEach((off) => {
      ...
      const tube = new THREE.Mesh(new THREE.TubeGeometry(curve, 24, 0.035, 6, false), stdMat(0x14171b, { roughness: 0.8 }));
      group.add(tube);
    });
  }
  return group;
...
function buildRam(pos, ram, status) {
  const group = new THREE.Group();
  const color = ram.tier === "Enthusiast" || ram.tier === "High-End" ? 0x3a4250 : 0x2c313a;
  [-0.16, 0.16].forEach((off) => {
    const stick = new THREE.Mesh(new THREE.BoxGeometry(0.07, 1.0, 0.46), stdMat(color, { metalness: 0.5 }));
...
function buildGpu(pos, gpu, status) {
  ...
  const card = new THREE.Mesh(new THREE.BoxGeometry(0.45, 1.25, lenU), stdMat(0x232830, { metalness: 0.5, roughness: 0.4 }));
  ...
  for (const fz of [card.position.z - lenU * 0.22, card.position.z + lenU * 0.22]) {
    const fan = new THREE.Mesh(new THREE.CylinderGeometry(0.28, 0.28, 0.06, 14), stdMat(0x1a1d22, { metalness: 0.3 }));
...
function buildStorage(pos, storageItem, status) {
  ...
  if (isHdd) {
    const box = new THREE.Mesh(new THREE.BoxGeometry(0.28, 0.5, 0.62), stdMat(0x2c313a, { metalness: 0.6 }));
    box.position.copy(pos);
    group.add(box);
  } else {
    const stick = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.1, 0.55), stdMat(0x1d2026, { metalness: 0.5 }));
...
function buildPsu(pos, psu, status) {
  const group = new THREE.Group();
  const box = new THREE.Mesh(new THREE.BoxGeometry(1.1, 0.55, 1.1), stdMat(0x20242b, { metalness: 0.6 }));
  box.position.copy(pos);
  group.add(box);
  const fan = new THREE.Mesh(new THREE.CylinderGeometry(0.42, 0.42, 0.05, 16), stdMat(0x2c313a, { metalness: 0.4 }));
  fan.rotation.x = Math.PI / 2;
...
function buildFans(pos, fansItem, status, dims) {
  ...
  const color = fansItem.argb ? STATUS_HEX[status] : 0x3a4047;
  for (let i = 0; i < count; i++) {
    const yOff = (i - (count - 1) / 2) * 1.0;
    const fan = new THREE.Mesh(new THREE.CylinderGeometry(0.5, 0.5, 0.05, 16), stdMat(0x262a30, { metalness: 0.4 }));
    fan.rotation.x = Math.PI / 2;
    fan.position.set(pos.x, pos.y + yOff, pos.z - 0.03);
    group.add(fan);
    const ring = new THREE.Mesh(new THREE.TorusGeometry(0.5, 0.018, 8, 20), stdMat(color, { emissive: fansItem.argb ? color : 0x000000, emissiveIntensity: fansItem.argb ? 0.6 : 0 }));
    ring.rotation.x = Math.PI / 2;
    ring.position.copy(fan.position);
    group.add(ring);
  }
...
function buildMonitor(pos, monitorItem) {
  ...
  const hgt = w * 0.56;
  const standPole = new THREE.Mesh(new THREE.CylinderGeometry(0.05, 0.05, 1.0, 8), stdMat(0x2c313a, { metalness: 0.6 }));
  standPole.position.set(pos.x, pos.y - hgt / 2 - 0.5, pos.z);
  group.add(standPole);
  const base = new THREE.Mesh(new THREE.CylinderGeometry(0.4, 0.42, 0.06, 16), stdMat(0x20242b, { metalness: 0.5 }));
  base.position.set(pos.x, pos.y - hgt / 2 - 1.0, pos.z);
  group.add(base);
  const panel = new THREE.Mesh(new THREE.BoxGeometry(w, hgt, 0.06), stdMat(0x14171b, { metalness: 0.3 }));
  panel.position.copy(pos);
  group.add(panel);
  const screen = new THREE.Mesh(new THREE.PlaneGeometry(w * 0.92, hgt * 0.88), stdMat(0x4fd8c9, { emissive: 0x4fd8c9, emissiveIntensity: 0.4, roughness: 0.2 }));
...
function buildOsGlyph(pos) {
  const mesh = new THREE.Mesh(new THREE.IcosahedronGeometry(0.26, 0), stdMat(0x4fd8c9, { emissive: 0x4fd8c9, emissiveIntensity: 0.6, metalness: 0.1, roughness: 0.3 }));
...
function BuildStage({ selections, activeCat, issues, onSelectCat }) {
  ...
  useEffect(() => {
    ...
    scene.add(key);
    const rim = new THREE.PointLight(0x4fd8c9, 0.6, 30);
    rim.position.set(-6, 4, -6);
    scene.add(rim);
    const warm = new THREE.PointLight(0xc9824a, 0.5, 30);
    ...
    function onPointerMove(e) {
      ...
      state.phi = Math.min(1.5, Math.max(0.25, state.phi - dy * 0.006));
      state.lastInteraction = Date.now();
    }
    ...
    function loop() {
      ...
      if (idle && !state.dragging) state.theta += 0.0022;
      ...
      if (state.frame % 3 === 0 && mount) {
        ...
        const next = (state.currentLabels || []).map((l) => {
          ...
          return {
            id: l.id, status: l.status, title: l.title,
  ...
  // ---- rebuild the rig whenever selections (or what they affect) change ----
  useEffect(() => {
  ...
  function resetView() {
    ...
    state.phi = 1.05;
    state.radius = 11;
    state.lastInteraction = Date.now() - 5000;
  }

  return (
    <div className="stage-wrap">
      <div className="stage-mount" ref={mountRef} />
      <div className="stage-labels">
        {labels.filter((l) => l.visible).map((l) => (
          <button
            ...
            title={l.title}
          >
            <StatusDot level={l.status} />
            <span>{CATEGORY_MAP[l.id]?.short}</span>
          </button>
        ))}
      </div>
      {hint && <div className="stage-hint">Drag to rotate \u00b7 scroll to zoom</div>}
      <button type="button" className="stage-reset" onClick={resetView} title="Reset view">
        <RotateCcw size={13} />
      </button>
    </div>
  );
...
export default function App() {
  ...
  function selectOption(catId, option) {
    setSelections((prev) => ({ ...prev, [catId]: prev[catId]?.id === option.id ? undefined : option }));
  }
  ...
  return (
    <div className="trace-root">
      ...
      <header className="header">
        <div className="brand">
          <span className="brand-mark"><CircuitBoard size={18} strokeWidth={2.2} /></span>
          <span className="brand-name">TRACE</span>
          <span className="brand-tag">build the circuit</span>
        </div>
        <input
        ...
        <div className="header-actions">
          <button className="btn btn-ghost" onClick={resetBuild} type="button">
            <RotateCcw size={14} /> New
          </button>
          <button className="btn btn-ghost" onClick={() => setSavePanelOpen((v) => !v)} type="button">
            <FolderOpen size={14} /> My builds
          </button>
          <button className="btn btn-outline" onClick={() => setSavePanelOpen("save")} type="button">
            <Save size={14} /> Save
          </button>
          <button className="btn btn-copper" onClick={() => { setSharePanelOpen(true); setShareCode(null); }} type="button">
      ...
      <div className="layout">
        {/* ---------------- CATEGORY RAIL ---------------- */}
        <nav className="rail" aria-label="Component categories">
          <div className="rail-progress">
            <span className="mono">{filledRequired}/{REQUIRED_IDS.length}</span> core parts
            <div className="rail-progress-bar"><div className="rail-progress-fill" style={{ width: `${(filledRequired / REQUIRED_IDS.length) * 100}%` }} /></div>
          </div>
          {CATEGORIES.map((cat) => {
            const Icon = cat.icon;
            const sel = selections[cat.id];
            ...
            return (
              ...
              >
                <Icon size={16} className="rail-icon" />
                <span className="rail-label">
                  <span className="rail-cat-name">{cat.label}{!cat.required && <em className="opt-suffix"> \u00b7 optional</em>}</span>
                  <span className="rail-cat-sel">{sel ? sel.name : "\u2014"}</span>
                </span>
        ...
        <main className="main">
          <div className="main-head">
            <div>
              <h1 className="main-title">{activeCategory.label}</h1>
              <p className="main-sub">
                {activeCategory.required ? "Required for a working build." : "Optional \u2014 add it if you need one."}
              </p>
            </div>
          ...
          <BuildStage selections={selections} activeCat={activeCat} issues={issues} onSelectCat={setActiveCat} />

          <div className="tier-row">
            {tiers.map((t) => (
              <TierPill key={t} tier={t} active={tierFilter === t} onClick={() => setTierFilter(t)} />
            ))}
          </div>

          <div className="opt-grid">
            {visibleOptions.length === 0 && (
              <div className="empty-state">No matches \u2014 try a different search or tier.</div>
            )}
        ...
        {/* ---------------- BUILD TICKET ---------------- */}
        <aside className={`ticket ${ticketOpenMobile ? "ticket-open" : ""}`}>
          <div className="ticket-header">
            <span>Build ticket</span>
            <span className="mono ticket-total">{INR(totalPrice)}</span>
          </div>

          <div className="ticket-trace">
            <svg className="trace-line" viewBox={`0 0 24 ${CATEGORIES.length * 56}`} preserveAspectRatio="none" aria-hidden="true">
              <line x1="12" y1="0" x2="12" y2={CATEGORIES.length * 56} className="trace-line-bg" />
              <line
                x1="12" y1="0" x2="12"
          ...
          <div className="wattage-block">
            <div className="wattage-label">
              <Gauge size={14} /> Estimated load <span className="mono">{estimatedWattage}W</span>
              {psuWattage > 0 && <span className="mono"> / {psuWattage}W</span>}
            </div>
            <div className="wattage-bar">
              <div
          ...
          <div className="issues-block">
            {issues.length === 0 ? (
              <div className="issue-ok"><Check size={14} /> No conflicts so far.</div>
            ) : (
              issues.map((iss, i) => (
                <div key={i} className={`issue-row issue-${iss.level}`}>
          ...
          <div className="ticket-footer-actions">
            <button className="btn btn-outline btn-block" onClick={() => setSavePanelOpen("save")} type="button">
              <Save size={14} /> Save build
            </button>
            <button className="btn btn-copper btn-block" onClick={() => { setSharePanelOpen(true); setShareCode(null); }} type="button">
      ...
      <button type="button" className="mobile-bar" onClick={() => setTicketOpenMobile((v) => !v)}>
        <span>{filledRequired}/{REQUIRED_IDS.length} parts</span>
        <span className="mono">{INR(totalPrice)}</span>
        <ChevronDown size={16} className={ticketOpenMobile ? "chev-up" : ""} />
      </button>

      {/* ---------------- SAVE / MY BUILDS PANEL ---------------- */}
      {savePanelOpen && (
        <div className="modal-backdrop" onClick={() => setSavePanelOpen(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-head">
              <h2>{savePanelOpen === "save" ? "Save this build" : "My saved builds"}</h2>
              <button className="icon-btn" onClick={() => setSavePanelOpen(false)} type="button"><X size={16} /></button>
            </div>

            {savePanelOpen === "save" && (
              <div className="modal-body">
                <label className="field-label" htmlFor="save-name">Name</label>
                <input id="save-name" className="field-input" value={buildName} onChange={(e) => setBuildName(e.target.value)} />
                <button className="btn btn-copper btn-block" onClick={() => handleSave(buildName)} type="button">
                  <Save size={14} /> Save build
                </button>
              </div>
            )}
            ...
            {savePanelOpen === true && (
              <div className="modal-body">
                {savedLoading && <p className="muted">Loading\u2026</p>}
                {!savedLoading && savedBuilds.length === 0 && (
                  <p className="muted">No saved builds yet. Save your current build to see it here.</p>
                )}
                <div className="saved-list">
                  {savedBuilds.map((b) => (
                    <div className="saved-item" key={b.id}>
                      <div className="saved-item-text">
                        <span className="saved-item-name">{b.name}</span>
                        <span className="saved-item-meta mono">{INR(b.total)} \u00b7 {Object.keys(b.ids || {}).length} parts</span>
                      </div>
                      <div className="saved-item-actions">
                        <button className="btn btn-outline btn-sm" onClick={() => { handleLoadSaved(b); setSavePanelOpen(false); }} type="button">Load</button>
                        <button className="icon-btn" onClick={() => handleDeleteSaved(b.id)} type="button" aria-label="Delete build"><Trash2 size={14} /></button>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      {/* ---------------- SHARE PANEL ---------------- */}
      {sharePanelOpen && (
        <div className="modal-backdrop" onClick={() => setSharePanelOpen(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-head">
              <h2>Share this build</h2>
              <button className="icon-btn" onClick={() => setSharePanelOpen(false)} type="button"><X size={16} /></button>
            </div>
            <div className="modal-body">
              <p className="muted">Generate a code, send it to anyone. They paste it below to load your exact selections.</p>
              {!shareCode ? (
                <button className="btn btn-copper btn-block" onClick={handleShare} type="button">
                  <Sparkles size={14} /> Generate share code
                </button>
              ) : (
                <div className="share-code-row">
                  <span className="share-code mono">{shareCode}</span>
                  <button className="btn btn-outline btn-sm" onClick={copyCode} type="button"><Copy size={13} /> Copy</button>
                </div>
              )}

              <div className="divider"><span>or load a build</span></div>
              ...
              <div className="load-code-row">
                <input
                  ...
                  maxLength={6}
                />
                <button className="btn btn-outline" onClick={handleLoadCode} type="button">Load</button>
              </div>
            </div>
          </div>
        </div>
